...
#
# CPlaylist:
# Playlist class. Supports loading of PLX files, RSS2.0 files, 
...
#            return -2
    ...
    def load_rss_20(self, filename='', mediaitem=CMediaItem(), proxy="CACHING"):
        ...
        loader.data = loader.data.replace('&amp;#39;',"'")
        loader.data = loader.data.replace('&#xe9;',"e")
        loader.data = loader.data.replace('&#xe8;',"e")
        loader.data = loader.data.replace('&#x2019;',"'")
        loader.data = loader.data.replace('&#xe0;',"e")
        loader.data = loader.data.replace('&eacute;',"e")
        loader.data = loader.data.replace('&rsquo;',"'")
        loader.data = loader.data.replace('&ccedil;',"c")
        loader.data = loader.data.replace('&egrave;',"e")
        loader.data = loader.data.replace('&#039;',"'")
        loader.data = loader.data.replace('&amp;nbsp;',"")
        loader.data = loader.data.replace('&amp;quot;',"")
        loader.data = loader.data.replace('&amp;rsquo;',"'")
        loader.data = loader.data.replace('&amp;laquo;',"'")
        loader.data = loader.data.replace('&amp;raquo;',"'")
        loader.data = loader.data.replace('&amp;',"&")
        loader.data = loader.data.replace('&nbsp;',".")
        loader.data = loader.data.replace('&quot;',"'")
